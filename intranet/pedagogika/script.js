function pridajDokument() {
    ...
    if (documentName == "" || documentName == null)
        ...
        xmlhttp.open("GET", "pedagogika/pridajDokument.php?dokument=" + documentName, true);
        xmlhttp.send();
    }
}
function pridajPrilohu(id) {
    ...
    if (prilohaMeno == "" || prilohaMeno == null || URL == "" || URL == null)
        ...
        xmlhttp.open("GET", "pedagogika/pridajPrilohu.php?dokument=" + dokumentMeno + "&priloha=" + prilohaMeno + "&href=" + URL, true);
        xmlhttp.send();
    }
}
...
function nacitajTabulku() {
    ...
    xmlhttp.open("GET", "pedagogika/nacitajDB.php", true);
    xmlhttp.send();
}
function modalDokument(object) {
    ...
    form.setAttribute("action", "pedagogika/upload.php");
...
function vymazDokument(id) {
    ...
    xmlhttp.open("GET", "pedagogika/vymazDokument.php?dokument=" + documentName, true);
    xmlhttp.send();
}
function vymazPrilohu(id, prilohaMeno) {
    ...
    xmlhttp.open("GET", "pedagogika/vymazPrilohu.php?dokument=" + documentName + "&priloha=" + prilohaMeno, true);
    xmlhttp.send();
}
