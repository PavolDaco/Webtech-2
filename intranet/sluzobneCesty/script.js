function pridajDokument() {
    ...
    if (documentName == "" || documentName == null)
        ...
        xmlhttp.open("GET", "sluzobneCesty/pridajDokument.php?dokument=" + documentName, true);
        xmlhttp.send();
    }
}
function pridajPrilohu(id) {
    ...
    if (prilohaMeno == "" || prilohaMeno == null || URL == "" || URL == null)
        ...
        xmlhttp.open("GET", "sluzobneCesty/pridajPrilohu.php?dokument=" + dokumentMeno + "&priloha=" + prilohaMeno + "&href=" + URL, true);
        xmlhttp.send();
    }
}
...
function nacitajTabulku() {
    ...
    xmlhttp.open("GET", "sluzobneCesty/nacitajDB.php", true);
    xmlhttp.send();
}
function modalDokument(object) {
    ...
    form.setAttribute("action", "sluzobneCesty/upload.php");
...
function vymazDokument(id) {
    ...
    xmlhttp.open("GET", "sluzobneCesty/vymazDokument.php?dokument=" + documentName, true);
    xmlhttp.send();
}
function vymazPrilohu(id, prilohaMeno) {
    ...
    xmlhttp.open("GET", "sluzobneCesty/vymazPrilohu.php?dokument=" + documentName + "&priloha=" + prilohaMeno, true);
    xmlhttp.send();
}
