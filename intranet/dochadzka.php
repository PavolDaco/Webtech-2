    ...
    <form method="post" action="">
        ...
        <div class="container">
            ...
            <label class="btn btn-primary">
                <input onchange="zmen4()" type="radio" name="vyber" value="mazať" checked="checked" id="radioBtn1"> pridávať/mazať
            </label>
            <label class="btn btn-primary">
                <input onchange="zmen4()" type="radio" name="vyber" value="editovať" id="radioBtn2"> pridávať/editovať
            </label>
            <button value="false" style="visibility: hidden" type="button" id="save" class="btn btn-primary"
                    onclick="skry()">Uložiť
            </button>
            <button style="visibility: hidden" type="button" id="cancel" class="btn btn-primary" onclick="rl()">Zrušiť
            </button>
            <button style="margin-top: 30px; border-color: deepskyblue" class="form-control" type="submit" id="show">
                zmeniť dátum
            </button>
            <?php
    ...
    <div style="width: 100%" class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label class="btn btn-primary">
                    <input onchange="zmen3()" type="radio" name="vyber" value="mazať" checked="checked" id="radioBtn4"> pridávať/mazať
                </label>
                <label class="btn btn-primary">
                    <input onchange="zmen3()" type="radio" name="vyber" value="editovať" id="radioBtn3"> pridávať/editovať
                </label>
                <button style="visibility: hidden" type="button" id="save2" class="btn btn-primary" onclick="skry()">
                    Uložiť
                </button>
                <button style="visibility: hidden" type="button" id="cancel2" class="btn btn-primary" onclick="rl()">
                    Zrušiť
                </button>
