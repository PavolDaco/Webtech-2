function pridajDokument() {
    ...
    if (documentName == "" || documentName == null)
        ...
        xmlhttp.open("GET", "publikacie/pridajDokument.php?dokument=" + documentName, true);
        xmlhttp.send();
    }
}
function pridajPrilohu(id) {
    ...
    if (prilohaMeno == "" || prilohaMeno == null || URL == "" || URL == null)
        ...
        xmlhttp.open("GET", "publikacie/pridajPrilohu.php?dokument=" + dokumentMeno + "&priloha=" + prilohaMeno + "&href=" + URL, true);
        xmlhttp.send();
    }
}
...
function nacitajTabulku() {
    ...
    xmlhttp.open("GET", "publikacie/nacitajDB.php", true);
    xmlhttp.send();
}
function modalDokument(object) {
    ...
    form.setAttribute("action", "publikacie/upload.php");
...
function vymazDokument(id) {
    ...
    xmlhttp.open("GET", "publikacie/vymazDokument.php?dokument=" + documentName, true);
    xmlhttp.send();
}
function vymazPrilohu(id, prilohaMeno) {
    ...
    xmlhttp.open("GET", "publikacie/vymazPrilohu.php?dokument=" + documentName + "&priloha=" + prilohaMeno, true);
    xmlhttp.send();
}
