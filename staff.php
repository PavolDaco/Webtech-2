...
echo "<title>Pracovníci</title><div class='container'><div style='margin-left:15px;'><br><input class='btn btn-default' type='text' id='myInput' onkeyup='filter1()' placeholder='Filter oddelenia'>
<input class='btn btn-default' type='text' id='myInput2' onkeyup='filter2()' placeholder='Filter zaradenia.'></div>";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $okno = "<div class='okno container' style='display:none;'>
...
function getPublikacie($login)
{
    ...
    if ($ldapSearchResult) {
        ...
        $returndata = "<table class='table table-hover' id='tabPublikacie' ><tr><th>Por.</th>  <th>Publikácie</th>  <th>Druh výsledku</th>  <th>Rok</th></tr>";
