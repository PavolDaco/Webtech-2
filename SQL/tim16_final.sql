...
--
-- Hostiteľ: localhost
-- Čas generovania: Pi 26.Máj 2017, 22:41
...
--
-- Štruktúra tabuľky pre tabuľku `doktorandi`
--
...
--
-- Sťahujem dáta pre tabuľku `doktorandi`
--
...
--
-- Štruktúra tabuľky pre tabuľku `pedagogika`
--
...
--
-- Sťahujem dáta pre tabuľku `pedagogika`
--
...
(1, '2017-02-07', 'Deň otvorených dverí na ÚAMT FEI STU', 'Open day at UAMT FEI STU', 'event001'),
(2, '2015-09-25', 'Noc výskumníkov', 'Night of researchers', 'event002');
...
--
-- Štruktúra tabuľky pre tabuľku `publikacie`
--
...
--
-- Sťahujem dáta pre tabuľku `publikacie`
--
...
--
-- Štruktúra tabuľky pre tabuľku `sluzobneCesty`
--
...
--
-- Sťahujem dáta pre tabuľku `sluzobneCesty`
--
...
(56, 'Pavol', 'Dačo', '', '', 'xdaco', '', '', '', 'testovanie', '', ''),
(57, 'Michal', 'Koplinger', '', '', 'xkoplingerm', '', '', NULL, 'testovanie', '', ''),
(58, 'Tomáš', 'Džadoň', '', '', 'xdzadont', '', '', NULL, 'testovanie', '', '');
...
--
-- Indexy pre tabuľku `sluzobneCesty`
--
...
--
-- AUTO_INCREMENT pre tabuľku `doktorandi`
--
ALTER TABLE `doktorandi`
...
--
-- AUTO_INCREMENT pre tabuľku `pedagogika`
--
ALTER TABLE `pedagogika`
...
--
-- AUTO_INCREMENT pre tabuľku `publikacie`
--
ALTER TABLE `publikacie`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
--
...
--
-- AUTO_INCREMENT pre tabuľku `sluzobneCesty`
--
ALTER TABLE `sluzobneCesty`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
--
