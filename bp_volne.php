...
<div class="container">
	...
	foreach($html->find('tr') as $element){	
		...
		if($element->children(1)->plaintext == 'BP' && $element->children(9)->plaintext == '--' ){
			...
			echo "<tr><td class='clickable'>".$nazov."<div class='okno' style='display:none;'><strong>".$nazov."</strong><br>".$annotation ."</div></td><td>".$skolitel."</td><td>".$program."</td></tr>";
